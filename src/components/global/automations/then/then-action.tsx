      ...
      <div className="flex flex-col gap-y-2">
              ...
              <div
                ...
                className={cn(
                  Listener === listener.type
                    ...
                    : "bg-background-80",
                  "p-3 rounded-xl flex flex-col gap-y-2 cursor-pointer hover:opacity-80 transition-all duration-100"
                )}
              >
        ...
        <form onSubmit={onFormSubmit} className="flex flex-col gap-y-2">
          <Textarea
            placeholder={
              Listener === "SMART_AI"
                ? "Add a prompt for that your smart ai can use ..."
                : "Add a message you want send to your customers"
            }
            {...register("prompt")}
            className="bg-background-80 ontline-none border-none ring-0 focus:ring-0"
          />
          <Input
            {...register("reply")}
